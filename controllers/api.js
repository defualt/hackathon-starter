...
module.exports = function(ns){
   ...
   */
  toReturn.getFoursquare = (req, res, next) => {
   ...
   * Tumblr API example.
   */
  toReturn.getTumblr = (req, res, next) => {
   ...
   */
  toReturn.getFacebook = (req, res, next) => {
   ...
   */
  toReturn.getScraping = (req, res, next) => {
   ...
   * GitHub API Example.
   */
  toReturn.getGithub = (req, res, next) => {
   ...
   */
  toReturn.getNewYorkTimes = (req, res, next) => {
    const query = {
   ...
   * Last.fm API example.
   */
  toReturn.getLastfm = (req, res, next) => {
   ...
   * Twitter API example.
   */
  toReturn.getTwitter = (req, res, next) => {
   ...
   * Post a tweet.
   */
  toReturn.postTwitter = (req, res, next) => {
    ...
    if (errors) {
      ...
      return res.redirect(ns('/api/twitter'));
    }
   ...
   * Steam API example.
   */
  toReturn.getSteam = (req, res, next) => {
  ...
  toReturn.postStripe = (req, res) => {
    ...
    stripe.charges.create({
      ...
      if (err && err.type === 'StripeCardError') {
        ...
        return res.redirect(ns('/api/stripe'));
      }
      req.flash('success', { msg: 'Your card has been successfully charged.' });
      res.redirect(ns('/api/stripe'));
    });
  };
   ...
   */
  toReturn.postTwilio = (req, res, next) => {
    ...
    if (errors) {
      req.flash('errors', errors);
      return res.redirect(ns('/api/twilio'));
    }
   ...
   */
  toReturn.postClockwork = (req, res, next) => {
    const message = {
   ...
   */
  toReturn.getLinkedin = (req, res, next) => {
   ...
   */
  toReturn.getInstagram = (req, res, next) => {
   ...
   * PayPal SDK example.
   */
  toReturn.getPayPal = (req, res, next) => {
    paypal.configure({
      mode: 'sandbox',
   ...
   * PayPal SDK example.
   */
  toReturn.getPayPalSuccess = (req, res) => {
   ...
   * PayPal SDK example.
   */
  toReturn.getPayPalCancel = (req, res) => {
  ...
  toReturn.getFileUpload = (req, res) => {
    res.render('api/upload', {
      title: 'File Upload'
    });
  };

  toReturn.postFileUpload = (req, res) => {
    req.flash('success', { msg: 'File was uploaded successfully.' });
    res.redirect(ns('/api/upload'));
  };
   ...
   */
  toReturn.getPinterest = (req, res, next) => {
   ...
   * Create a pin.
   */
  toReturn.postPinterest = (req, res, next) => {
    ...
    if (errors) {
      req.flash('errors', errors);
      return res.redirect(ns('/api/pinterest'));
    }
  ...
  toReturn.getGoogleMaps = (req, res) => {
